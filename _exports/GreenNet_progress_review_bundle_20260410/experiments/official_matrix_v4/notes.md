...
## Change vs v3
- single knob change: `toggle_cooldown_steps=4`, `global_toggle_cooldown_steps=10`
- keep: `energy_weight=1800`, `toggle_penalty=0.0005`, `blocked_action_penalty=0.0003`
