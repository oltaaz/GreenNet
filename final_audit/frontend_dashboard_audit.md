...
Evidence:
- The repo explicitly positions React as the official public/demo UI in [README.md](/Users/oltazagraxha/Desktop/GreenNet/README.md#L5), [frontend/greennet-ui/README.md](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/README.md#L1), and [dashboard/README.md](/Users/oltazagraxha/Desktop/GreenNet/dashboard/README.md#L3).
- The React app has distinct pages for home, dashboard, results, simulator, and about in [App.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/App.tsx).
- The repo-root command starts backend + frontend together via [package.json](/Users/oltazagraxha/Desktop/GreenNet/package.json#L8).
...
Evidence:
- `src/lib/api.ts` is a single typed client layer, matching the docs claim in [frontend/greennet-ui/README.md](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/README.md#L10).
- It consumes real endpoints for health, runs, summaries, per-step metrics, topology, steps, official locked results, and final evaluation in [api.ts](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/lib/api.ts#L910).
...
Evidence:
- The `/results` page explicitly frames the final story around traditional baseline vs heuristic vs AI in [ComparePage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/ComparePage.tsx#L280).
...
- It surfaces thresholds, QoS/stability badges, and source artifact paths in [ComparePage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/ComparePage.tsx#L313).
...
- **PARTIAL**: Some of the visuals are inferred/generated rather than direct backend truth. Topology can be generated when missing, and demo traces can be synthesized when run listing fails in [api.ts](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/lib/api.ts#L910) and [api.ts](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/lib/api.ts#L1013).
- **PARTIAL**: The simulator promises “real link states” in [SimulatorPage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/SimulatorPage.tsx#L243), but packet motion and some topology/layout behavior are still presentational approximations rather than fully measured network animation.

### Public React UI vs internal Streamlit separation

- **PASS**: The repo now clearly says React is official and Streamlit is internal in [dashboard/README.md](/Users/oltazagraxha/Desktop/GreenNet/dashboard/README.md#L3), [frontend/greennet-ui/README.md](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/README.md#L3), and [README.md](/Users/oltazagraxha/Desktop/GreenNet/README.md#L5).
- **PARTIAL**: The internal Streamlit app still contains an experiment launcher and a filesystem-first run browser in [dashboard/app.py](/Users/oltazagraxha/Desktop/GreenNet/dashboard/app.py#L41). That is fine for internal tooling, but it remains a second presentation surface that could confuse reviewers if they discover it.

### API consumption and integration quality

- **PASS**: The public UI uses real backend endpoints and a Vite proxy to `localhost:8000` in [vite.config.ts](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/vite.config.ts).
- **PARTIAL**: The client has a strong fallback strategy, but the fallback strategy is presentation-risky. If `/api/runs` cannot load, the app silently substitutes generated demo runs before showing a banner in [api.ts](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/lib/api.ts#L910) and [DashboardPage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/DashboardPage.tsx#L447).

### Reviewer-facing clarity

- **PASS**: There is one obvious startup command, `npm run dev`, in [README.md](/Users/oltazagraxha/Desktop/GreenNet/README.md#L7).
...
- Consistent visual system and deliberate styling in [app.css](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/styles/app.css).
...
Evidence:
- If run listing fails, the UI falls back to generated runs in [api.ts](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/lib/api.ts#L910).
- The dashboard then renders “generated simulation data” with a notice in [DashboardPage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/DashboardPage.tsx#L447).
- The compare page can mix generated live traces with backend final artifacts in [ComparePage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/ComparePage.tsx#L306).
...
Evidence:
- Missing topology triggers `fallbackTopology(...)` in [api.ts](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/lib/api.ts#L1013).
- The dashboard and simulator expose notices when generated layout is used in [DashboardPage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/DashboardPage.tsx#L453) and [SimulatorPage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/SimulatorPage.tsx#L262).
...
- `npm --prefix frontend/greennet-ui run lint` failed with:
  - `react-hooks/set-state-in-effect` and `react-refresh/only-export-components` in [useBackendStatus.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/hooks/useBackendStatus.tsx#L38)
  - unused variable in [api.ts](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/lib/api.ts#L65)
  - hook dependency warnings in [TopologyPanel.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/components/TopologyPanel.tsx) and [DashboardPage.tsx](/Users/oltazagraxha/Desktop/GreenNet/frontend/greennet-ui/src/pages/DashboardPage.tsx)
...
- A separate analyst/developer tool, explicitly described that way in [dashboard/README.md](/Users/oltazagraxha/Desktop/GreenNet/dashboard/README.md#L3).
- It provides single-run inspection, policy comparison, and an internal run launcher in [dashboard/app.py](/Users/oltazagraxha/Desktop/GreenNet/dashboard/app.py#L119).

### Strengths

- Useful for internal analysis.
- More filesystem-oriented and pragmatic for ad hoc exploration.
- The title/caption correctly disclaim it as internal in [dashboard/app.py](/Users/oltazagraxha/Desktop/GreenNet/dashboard/app.py#L120).

### Weaknesses

- It is visibly a second dashboard product, not just a hidden utility.
- The launcher runs experiments directly from the UI in [dashboard/app.py](/Users/oltazagraxha/Desktop/GreenNet/dashboard/app.py#L41), which is fine internally but not something you want reviewers mistaking for the official submission experience.
...
- A reviewer can start the official frontend from the repo root using [README.md](/Users/oltazagraxha/Desktop/GreenNet/README.md#L7).
